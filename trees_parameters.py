...
# proposed changes
# only leaves respire (lose biomass)
# NOBODY needs water or minerals; they just impact photosynthesis
# everything is converted to a "common currency" by photosyhthesis
# 
...
BIOMASS_DISTRIBUTION_ORDER = [
							["fruit clusters", "flower clusters", "leaf clusters","root", 'branches', 'axillary meristems', "apical meristems", "child"],
...
WATER_DISTRIBUTION_ORDER = [
							["fruit clusters", "flower clusters", "leaf clusters","child",'branches', 'axillary meristems', "apical meristems"],
...
WATER_TO_MAKE_ONE_FLOWER_CLUSTER = 5
MINERALS_TO_MAKE_ONE_FLOWER_CLUSTER = 3
...
START_FLOWER_CLUSTER_WATER = 1
OPTIMAL_FLOWER_CLUSTER_WATER = 6
WATER_USED_BY_FLOWER_CLUSTER_PER_DAY = 0.1
FLOWER_CLUSTER_DIES_IF_WATER_GOES_BELOW = 0.01

START_FLOWER_CLUSTER_MINERALS = 1
OPTIMAL_FLOWER_CLUSTER_MINERALS = 6
MINERALS_USED_BY_FLOWER_CLUSTER_PER_DAY = 0.1
FLOWER_CLUSTER_DIES_IF_MINERALS_GOES_BELOW = 0.01
...
START_FRUIT_CLUSTER_WATER = 1
OPTIMAL_FRUIT_CLUSTER_WATER = 6
WATER_USED_BY_FRUIT_CLUSTER_PER_DAY = 0.1
FRUIT_CLUSTER_DIES_IF_WATER_GOES_BELOW = 0.01

START_FRUIT_CLUSTER_MINERALS = 1
OPTIMAL_FRUIT_CLUSTER_MINERALS = 6
MINERALS_USED_BY_FRUIT_CLUSTER_PER_DAY = 0.1
FRUIT_CLUSTER_DIES_IF_MINERALS_GOES_BELOW = 0.01
